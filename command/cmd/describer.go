...
import (
	...
	"github.com/opengovern/og-describer-cloudflare/pkg/describer"
	model "github.com/opengovern/og-describer-cloudflare/pkg/sdk/models"
	"github.com/opengovern/og-describer-cloudflare/provider"
	"github.com/opengovern/og-describer-cloudflare/provider/configs"
	"github.com/opengovern/og-describer-cloudflare/steampipe"
...
var describerCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		creds := configs.IntegrationCredentials{
			Token: "WsU-1l6xFISIobrMNLYOdnAWdbS2Efzfh5Cvsn18",
