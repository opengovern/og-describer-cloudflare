...
func processAccessPolicies(ctx context.Context, handler *CloudFlareAPIHandler, account *cloudflare.Account, app cloudflare.AccessApplication, cloudFlareChan chan<- models.Resource, wg *sync.WaitGroup) {
...
func processAccessPolicy(ctx context.Context, handler *CloudFlareAPIHandler, account *cloudflare.Account, apps []cloudflare.AccessApplication, resourceID string, appID, appName *string) (*cloudflare.AccessPolicy, error) {
