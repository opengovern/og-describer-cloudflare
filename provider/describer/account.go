...
func processAccounts(ctx context.Context, handler *CloudFlareAPIHandler, cloudFlareChan chan<- models.Resource, wg *sync.WaitGroup) {
...
func processAccount(ctx context.Context, handler *CloudFlareAPIHandler, resourceID string) (*cloudflare.Account, error) {
