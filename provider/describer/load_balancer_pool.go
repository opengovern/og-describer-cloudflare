...
func processLoadBalancerPools(ctx context.Context, handler *CloudFlareAPIHandler, cloudFlareChan chan<- models.Resource, wg *sync.WaitGroup) {
...
func processLoadBalancerPool(ctx context.Context, handler *CloudFlareAPIHandler, resourceID string) (*cloudflare.LoadBalancerPool, error) {
