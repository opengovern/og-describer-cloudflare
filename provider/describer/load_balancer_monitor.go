...
func processLoadBalancerMonitors(ctx context.Context, handler *CloudFlareAPIHandler, cloudFlareChan chan<- models.Resource, wg *sync.WaitGroup) {
...
func processLoadBalancerMonitor(ctx context.Context, handler *CloudFlareAPIHandler, resourceID string) (*cloudflare.LoadBalancerMonitor, error) {
