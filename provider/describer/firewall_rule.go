...
func processFirewallRules(ctx context.Context, handler *CloudFlareAPIHandler, zone cloudflare.Zone, cloudFlareChan chan<- models.Resource, wg *sync.WaitGroup) {
...
func processFirewallRule(ctx context.Context, handler *CloudFlareAPIHandler, zones []cloudflare.Zone, resourceID string, zoneID *string) (*cloudflare.FirewallRule, error) {
	var firewallRules []cloudflare.FirewallRule
