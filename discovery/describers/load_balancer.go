...
func ListLoadBalancers(ctx context.Context, handler *model.CloudFlareAPIHandler, stream *models.StreamSender) ([]models.Resource, error) {
...
func GetLoadBalancer(ctx context.Context, handler *model.CloudFlareAPIHandler, resourceID string) (*models.Resource, error) {
	var zoneID *string
	var zoneName *string
...
func processLoadBalancers(ctx context.Context, handler *model.CloudFlareAPIHandler, zone cloudflare.Zone, cloudFlareChan chan<- models.Resource, wg *sync.WaitGroup) {
...
func processLoadBalancer(ctx context.Context, handler *model.CloudFlareAPIHandler, zones []cloudflare.Zone, resourceID string, zoneID, zoneName *string) (*cloudflare.LoadBalancer, error) {
	var loadBalancers []cloudflare.LoadBalancer
