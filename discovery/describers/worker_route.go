...
func ListWorkerRoutes(ctx context.Context, handler *model.CloudFlareAPIHandler, stream *models.StreamSender) ([]models.Resource, error) {
...
func GetWorkerRoute(ctx context.Context, handler *model.CloudFlareAPIHandler, resourceID string) (*models.Resource, error) {
	var zoneID *string
	var zoneName *string
...
func processWorkerRoutes(ctx context.Context, handler *model.CloudFlareAPIHandler, zone cloudflare.Zone, cloudFlareChan chan<- models.Resource, wg *sync.WaitGroup) {
...
func processWorkerRoute(ctx context.Context, handler *model.CloudFlareAPIHandler, zones []cloudflare.Zone, resourceID string, zoneID, zoneName *string) (*cloudflare.WorkerRoute, error) {
	var resp cloudflare.WorkerRoutesResponse
