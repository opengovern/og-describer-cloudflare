...
func ListZones(ctx context.Context, handler *model.CloudFlareAPIHandler, stream *models.StreamSender) ([]models.Resource, error) {
...
func GetZone(ctx context.Context, handler *model.CloudFlareAPIHandler, resourceID string) (*models.Resource, error) {
...
func processZones(ctx context.Context, handler *model.CloudFlareAPIHandler, cloudFlareChan chan<- models.Resource, wg *sync.WaitGroup) {
...
func processZone(ctx context.Context, handler *model.CloudFlareAPIHandler, resourceID string) (*cloudflare.Zone, error) {
...
func getZoneSettings(ctx context.Context, handler *model.CloudFlareAPIHandler, zone *cloudflare.Zone) ([]cloudflare.ZoneSetting, error) {
...
func getZoneDNSSEC(ctx context.Context, handler *model.CloudFlareAPIHandler, zone *cloudflare.Zone) (*cloudflare.ZoneDNSSEC, error) {
