...
func ListDNSRecords(ctx context.Context, handler *model.CloudFlareAPIHandler, stream *models.StreamSender) ([]models.Resource, error) {
...
func GetDNSRecord(ctx context.Context, handler *model.CloudFlareAPIHandler, resourceID string) (*models.Resource, error) {
	var zoneID *string
	var zoneName *string
...
func processDNSRecords(ctx context.Context, handler *model.CloudFlareAPIHandler, zone cloudflare.Zone, cloudFlareChan chan<- models.Resource, wg *sync.WaitGroup) {
...
func processDNSRecord(ctx context.Context, handler *model.CloudFlareAPIHandler, zones []cloudflare.Zone, resourceID string, zoneID, zoneName *string) (*cloudflare.DNSRecord, error) {
	var dnsRecords []cloudflare.DNSRecord
