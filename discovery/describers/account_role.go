...
func ListAccountRoles(ctx context.Context, handler *model.CloudFlareAPIHandler, stream *models.StreamSender) ([]models.Resource, error) {
...
func GetAccountRole(ctx context.Context, handler *model.CloudFlareAPIHandler, resourceID string) (*models.Resource, error) {
	account, err := getAccount(ctx, handler)
	if err != nil {
		return nil, err
	}
...
func processAccountRoles(ctx context.Context, handler *model.CloudFlareAPIHandler, account *cloudflare.Account, cloudFlareChan chan<- models.Resource, wg *sync.WaitGroup) {
...
func processAccountRole(ctx context.Context, handler *model.CloudFlareAPIHandler, account *cloudflare.Account, resourceID string) (*cloudflare.AccountRole, error) {
